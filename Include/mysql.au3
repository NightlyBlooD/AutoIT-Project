...
#cs
Update for NightlyBlooD
Add new Functions
~ UpdateColumn($oConnectionObj, $sTable,$sColumn,$sColumn_Value,$WHERE_Column=0,$WHERE_Column_Value='')
#ce

Func UpdateColumn($oConnectionObj, $sTable,$sColumn,$sColumn_Value,$WHERE_Column,$WHERE_Column_Value='')
	If IsObj($oConnectionObj) Then
		$quer = $oConnectionObj.execute ("UPDATE "&$sTable&" SET "&$sColumn&"='"&$sColumn_Value&"' WHERE "&$WHERE_Column&"='"&$WHERE_Column_Value&"'")
	EndIf
EndFunc
